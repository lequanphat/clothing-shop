...
import ProductItem from '../../../products/ProductList/ProductItem';
    ...
    return (
        <div className="flex-1 flex flex-col items-center pb-[20px]">
            ...
            <div className="flex items-center px-[20px] py-[20px] justify-between w-[100%]">
                ...
                <div className="w-[90%] h-[360px] overflow-hidden  relative   ">
                    <div className="grid grid-cols-6 gap-[30px]  w-[200%] h-[100%]  absolute top-[0]  " style={{ left: page*-33.33 + '%' }}>
